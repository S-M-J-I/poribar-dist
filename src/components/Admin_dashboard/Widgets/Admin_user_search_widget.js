...
function Admin_user_search_widget(props) {
    ...
    return (
        <tr className='table-light table_rows'>
            ...
            <td><input placeholder="Email" value={props.user.email} readOnly /></td>
            <td><input placeholder="Phone" value={props.user.phone} readOnly /></td>
            <td><input placeholder="Date" value={props.user.date} readOnly /></td>
            <td><input placeholder="Type" value={props.user.type} readOnly /></td>
            </>}
